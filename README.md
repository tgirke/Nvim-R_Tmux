...
+ Note: this is the new and up-to-date version of the [Nvim-R-Tmux Tutorial](https://gist.github.com/tgirke/7a7c197b443243937f68c422e5471899) on Gist.
...
2. [Installation](#intallation)
  2.1. [Quick install](#quickinstall)
  2.2. [Neovim](#neovim)
    3. [Tmux](#tmux) 
